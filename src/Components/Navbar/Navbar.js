...
const Navbar = () => {
    ...
    const Menus = [
        ...
        { name: "Skills", icon:"barbell-outline", dis: "translate-x-16",link: '#skill' },
        { name: "Projects", icon:"cube-outline", dis: "translate-x-32",link: '#projects' },
        { name: "About", icon: "person-outline", dis: "translate-x-48",link: '#about' },
        { name: "Contact", icon: "mail-outline", dis: "translate-x-64", link: '#contact'},
      ...
      return (
          ...
          <ul className="flex relative">
            <span
              className={`bg-fuchsia-500 duration-500 ${Menus[active].dis} border-4 border-slate-300 h-16 w-16 absolute
             -top-5 rounded-full`}
            >
              <span
        ...
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] pr-5 pl-5 duration-300 bg-fuchsia-500'>
            <a href='https://www.linkedin.com/in/sreemaye-chakrabortty-73ab85134/' target="_blank" rel="noopener noreferrer"
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] pr-5 pl-5 duration-300 bg-[#333333]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://github.com/Sreemaye44' target="_blank" rel="noopener noreferrer"
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px]  pr-5 pl-5 duration-300 bg-[#565f69]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='Resume.Sreemaye.pdf' download='Sreemaye Chakrabortty'
            >
